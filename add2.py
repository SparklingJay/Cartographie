...
Consigne :
- Décris en UNE phrase simple quels sont les risques et détournements possibles associés à ces usages de chatbots IA. 
...
if __name__ == "__main__":
    ...
    input_file = "data_add/Carto_going.csv"
    output_file = "data_add/Carto_final.csv"

    df = pd.read_csv(input_file, sep=";")

    # Vérification des colonnes attendues
    expected_cols = ["Famille de métiers", "Métier", "Tâche", "Impact potentiel", "Exemple"]
